...
e.parser = function(a) {
    ...
    default:
        if (/^\s*\|\s*[\w\$]/.test(e)) {
            ...
            for (var l = 0,
            m = a.split("|"), n = m.length, o = m[l++]; n > l; l++) {
                o = z(o, m[l])
            }
            a = (k ? "=": "=#") + o
        } else {
    ...
    var tpl = function(path, data, obj){
        var obj = obj || document.getElementById('content');
        obj = typeof(obj)=='object' ? obj[0] : obj;
        
        console.log();
　　　　get(path, function(tpl){
            var render = d.compile(tpl);
　　　　　　obj.innerHTML = render(data);
　　　　});  
    }
    "function" == typeof define ? define(function(){return tpl}) : "undefined" != typeof exports ? module.exports = tpl: this.tpl = tpl;
}();